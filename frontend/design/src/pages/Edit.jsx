    ...
    return (
        <div>
            ...
            <div className='grid grid-cols-1 h-16 ' >
                <div className='grid grid-cols-9 '>
                    <div className='grid grid-rows-3  '>
                        ...
                        <img src='/assets/mohanlal.jpeg' className='h-16 rounded-full ml-16  '></img>
                        <p className='ml-16 w-full'>All your account information can be accessed<br/> and edited here but your mail will remain<br/> un-edited</p>
                    </div>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className='grid grid-cols-1 mt-36'>
                ...
                <div>
                    <input className=' mx-36 w-60 border-solid border-2 w-52'
                        type="text"
                        name="name"
                ...
                <div>
                    <input className=' mx-36 border-solid border-2 w-52'
                        type="text"
                        name="username"
                ...
                <div className='grid grid cols-6'>
                    ...
                    <div className='grid grid-cols-6 mx-36 rounded-full'>
                        ...
                        <button type="button" onClick={handleButtonClick}>
                            <img src="/assets/plus-solid.svg" alt="" className='h-5 ' />
                        </button>
                    </div>
